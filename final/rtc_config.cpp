...
bool clock_Synchronization() {
    ...
    struct tm timeinfo;
    if (!getLocalTime(&timeinfo, 10000)) { Serial.println("ERR: NTP sync failed"); return false; }
